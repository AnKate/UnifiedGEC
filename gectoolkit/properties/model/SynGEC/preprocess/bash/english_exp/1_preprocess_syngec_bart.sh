...
PROCESSED_DIR="../../preprocess_data/${language}_${dataset}_with_syntax_bart"
...
### if lanuage=='chinese',# 376
#       train_src_file = args.trainpref.replace("char", suffix) + ".src"  # 11.10改
...
PROCESSED_DIR="../../preprocess_data/${language}_${dataset}_test_with_syntax_bart"
