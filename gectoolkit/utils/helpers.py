...
def get_verb_form_dicts():
    ...
    path_to_dict = Path(__file__).resolve().parent.parent / "properties" / "model" / "GECToR"
    # print("files: ", os.listdir(path_to_dict))
    path_to_dict = os.path.join(path_to_dict, "verb-form-vocab.txt")
