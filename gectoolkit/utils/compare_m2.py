...
def process_edits(edits, dt=False, ds=False, single=False, multi=False, filt=None, cse=False):
    if filt is None:
        filt = []
    coder_dict = {}
...
def evaluate_edits(hyp_dict, ref_dict, best, sent_id, original_sentence, verbose=False, beta=0.5):
