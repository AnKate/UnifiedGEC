...
def setup_task(task_cfg: Union[DictConfig, Namespace], **kwargs): # 由任务注册表 TASK_REGISTRY 中的相应任务处理。任务配置可以是 DictConfig 或 Namespace 类型。
    # pdb.set_trace()
    if isinstance(task_cfg, DictConfig ):  # 检查 task_cfg 是否是 DictConfig 类型的对象。
