...
class SubsampleDataset(BaseWrapperDataset):
    """Subsamples a given data by a specified ratio. Subsampling is done on the number of examples

    Args:
        dataset (~torch.utils.data.Dataset): data to subsample
    ...
    def __init__(self, dataset, size_ratio, shuffle=False):
        ...
        logger.info(
            "subsampled data from {} to {} (ratio={})".format(
