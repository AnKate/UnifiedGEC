...
class NoisingDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        **kwargs
        ...
        Args:
            src_dataset (~torch.utils.data.Dataset): data to wrap.
                to build self.src_dataset --
                a LanguagePairDataset with src data as the source data and
                None as the target data. Should NOT have padding so that
    ...
    def __len__(self):
        """
        The length of the noising data is the length of src.
        """
