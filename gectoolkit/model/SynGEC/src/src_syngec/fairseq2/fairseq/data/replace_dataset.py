...
class ReplaceDataset(BaseWrapperDataset):
    """Replaces tokens found in the data by a specified replacement token

    Args:
        dataset (~torch.utils.data.Dataset): data to replace tokens in
        ...
        as many as the number of objects returned by the underlying data __getitem__ method.
    """
