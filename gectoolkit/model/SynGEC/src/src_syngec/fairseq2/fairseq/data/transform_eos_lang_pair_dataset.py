...
class TransformEosLangPairDataset(FairseqDataset):
    ...
    collated samples of language pair data.

    Note that the transformation is applied in :func:`collater`.

    Args:
        dataset (~fairseq.data.FairseqDataset): data that collates sample into
    ...
    @property
    def sizes(self):
        # data.sizes can be a dynamically computed sizes:
