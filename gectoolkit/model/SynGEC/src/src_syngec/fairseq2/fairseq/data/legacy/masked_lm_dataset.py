...
class MaskedLMDataset(FairseqDataset):
    """
    A wrapper Dataset for masked language modelling. The data
    ...
    Args:
        ...
        has_pairs: Specifies whether the underlying data
            generates a pair of blocks along with a sentence_target or not.
            Setting it to True assumes that the underlying data generates a
