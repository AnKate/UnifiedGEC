...
class CoVoST(Dataset):
    ...
    Args:
        root (str): root path to the data and generated manifests/features
        ...
        download (bool, optional): Whether to download the data if it is not
    ...
    def __getitem__(
        ...
        """Load the n-th sample from the data.
