...
"""
Helper script to pre-compute embeddings for a wav2letter++ data
"""
...
class EmbeddingDatasetWriter(object):
    """Given a model and a wav2letter++ data, pre-compute and store embeddings

    Args:
        input_root, str :
            Path to the wav2letter++ data
        output_root, str :
