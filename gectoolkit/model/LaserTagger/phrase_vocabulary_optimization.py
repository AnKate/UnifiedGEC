...
from gectoolkit.model.LaserTagger.compute_lcs import _compute_lcs
...
#     'the vocabulary.')
output_file = 'tmp_output/label_map.txt'
# flags.DEFINE_string(
...
def main():
    ...
    phrase_counter, all_added_phrases, max_seq_length = _added_token_counts(
        data_iterator, enable_swap_tag, max_input_examples)
    ...
    with open(output_file, 'w') as writer:
        ...
        with open(statistics_file, 'w') as stats_writer:
            ...
            for i, (phrase, count) in enumerate(
                    phrase_counter.most_common(vocabulary_size +
